...
public enum ErrorCode {
    ...
    INVALID_EVENT_START_TIME(400, Constant.INVALID_EVENT_START_TIME, HttpStatus.BAD_REQUEST),
    EVENT_TIME_CANNOT_BE_IN_THE_PAST(400, Constant.EVENT_TIME_CANNOT_BE_IN_THE_PAST, HttpStatus.BAD_REQUEST);
